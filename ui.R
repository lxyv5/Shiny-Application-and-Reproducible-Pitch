  ...
  fluidRow(
    column(3,
      HTML("<b>Explores the dialog of all Star Trek TNG Episodes</b><br>
                 ...
                 <i>Code for this project <a href=\"https://github.com/lxyv5/Shiny-Application-and-Reproducible-Pitch\" target=\"_blank\">https://github.com/lxyv5/Shiny-Application-and-Reproducible-Pitch</a></i><br>
